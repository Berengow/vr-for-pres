...
panorama = new PANOLENS.ImagePanorama( 'IMG_8635 Panorama.jpg' );
panorama.addEventListener( 'enter-fade-start', function(){
  viewer.tweenControlCenter( lookAtPositions[0], 0 );
} );

panorama2 = new PANOLENS.ImagePanorama( 'IMG_9063 Panorama.jpg' );
...
infospot.addHoverElement(document.querySelector("#desc-container"), 200);
